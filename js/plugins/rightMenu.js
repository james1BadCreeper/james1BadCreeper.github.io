const RightMenu = (() => {
  ...
  fn.setMenuItem = (event) => {
    ...
    if (selectText) {
      ...
      DOMController.visible(_googleSearch);
      DOMController.visible(_bingSearch);
      DOMController.visible(_baiduSearch);
      ...
      DOMController.visible(_googleSearch, false);
      DOMController.visible(_bingSearch, false);
      DOMController.visible(_baiduSearch, false);
    }
